class Config:
    ...
    def get_default_config(args):
        ...
        config.PATIENCE = config.NUM_EPOCHS  # 10
        config.BATCH_SIZE = 128  # 512
        config.TEST_BATCH_SIZE = config.BATCH_SIZE  # 256
        ...
        config.MAX_TO_KEEP = config.NUM_EPOCHS + 1
        config.EMBEDDINGS_SIZE = 32
        config.RNN_SIZE = config.EMBEDDINGS_SIZE * 2
        return config
